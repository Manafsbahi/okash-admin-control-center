...
import { z } from "zod";
import { businessAccountSchema } from "@/schemas/customerSchemas";
...
interface BusinessAccountFormProps {
  onSubmit: (values: z.infer<typeof businessAccountSchema>) => Promise<void>;
  loading: boolean;
}

const BusinessAccountForm = ({ onSubmit, loading }: BusinessAccountFormProps) => {
  const form = useForm<z.infer<typeof businessAccountSchema>>({
